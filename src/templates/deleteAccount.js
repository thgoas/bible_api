const deleteAccountTemplate = (user) => {
  return `
          ...
          <tr>
           ...
           <tr>
            <td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
              <p style="text-align: center;">Foi solicitado a exclusão de sua conta.</p> 
              <p style="text-align: center;">Sua conta será excluída dentro de 60 dias...</p>
