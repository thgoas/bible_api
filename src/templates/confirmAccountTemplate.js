 const confirmAccountTemplate = (token, user) => {
  return `
    <!DOCTYPE html
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td style="color: #153643; font-family: Arial, sans-serif; font-size: 24px;">
              <p style="text-align: center;"><b>Parabéns ${user}</b></p>
            </td>
          </tr>
          <tr>
            <td
              style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
              <p style="text-align: center;">Você se cadastrou no Hora do Devocional.</p>
              <p style="text-align: center;">Clique no botão abaixa para confirma seu cadastro!.</p>
...
module.exports = confirmAccountTemplate
